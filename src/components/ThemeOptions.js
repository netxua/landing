    ...
    render() {
        ...
        return (
            <div className="fixed-plugin" onClick={e => e.stopPropagation()}>
                <div className={cx("dropdown show-dropdown", { open: isShowingDropdown })} >

                    <a data-toggle="dropdown" aria-expanded="false" onClick={e => { e.stopPropagation(); this.toggleDropdown(); }} >
                        ...
                        <li className="adjustments-line">
                            <a href="javascript:void(0)" className="switch-trigger" >
                                ...
                                <div className="switch has-switch" data-on-label="ON" data-off-label="OFF" onClick={this.toggleEnableBackgroundImage}>
                                    <div className={cx("switch-animate", { 'switch-on': enableBackgroundImage, 'switch-off': !enableBackgroundImage })} >
